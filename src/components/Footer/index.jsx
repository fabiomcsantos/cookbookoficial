    ...
    <div className={styles.Root}>
     <footer className={styles.Footer}>
        ...
        <div className={styles.LinkSocial}>
          <a href="#" className={styles.Social}><img className={styles.Icons} src="https://github.com/fabiomcsantos/cookbookoficial/blob/main/public/icons/instagram.png?raw=true" alt="" /></a>
          <a href="#" className={styles.Social}><img className={styles.Icons1} src="https://github.com/fabiomcsantos/cookbookoficial/blob/main/public/icons/email.png?raw=true" alt="" /></a>
        </div>     
